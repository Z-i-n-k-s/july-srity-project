...
const router = createBrowserRouter([
  {
    ...
    children: [
     ...
     { path: "archive", element: <ArchivePage /> },
      { path: "archive/:id", element: <ArchiveDetailsPage /> },
      { path: "timeline", element: <TimelinePage /> },
      { path: "stories", element: <StoriesPage /> },
      { path: "stories/:id", element: <StoryDetailsPage /> },
      { path: "voices", element: <VoicesPage /> },
      { path: "aynaghor", element: <AynaghorPage /> },
      { path: "july-history", element: <JulyHistoryPage /> },
      { path: "support", element: <SupportPage /> },
      { path: "missing-persons", element: <MissingPersonsPage /> },
      { path: "missing-persons/:id", element: <MissingPersonDetailsPage /> },
