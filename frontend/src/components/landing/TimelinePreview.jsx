    ...
    <section className="section-pad">
      <div className="page-shell">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <SectionHeading
            label="Chronology"
            title="Follow the events of July."
            description="Move through a verified chronological view where each event can be connected back to source records."
          />
          <Button to="/timeline" variant="secondary" showArrow>
            See the July Timeline
          </Button>
        </div>
          ...
          <div className="grid gap-8 md:grid-cols-5 md:gap-4">
            {timelineEvents.map((event, index) => (
              <motion.article
                ...
                className="relative pl-9 md:pl-0 md:pt-24"
              >
                ...
                <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-5 transition hover:-translate-y-1 hover:border-archive-amber/30">
                  <p className="text-sm font-bold text-archive-amber">
                    {event.date}
                  </p>
                  ...
                  <p className="mt-3 text-sm leading-6 text-[#B9B5AE]">
                    {event.summary}
                  </p>
                  <div className="mt-4 space-y-2 text-xs text-archive-muted">
                    ...
                    <span className="flex items-center gap-2">
                      ...
                      {event.mediaCount} media records
                    </span>
                    <span className="flex items-center gap-2 text-archive-teal">
