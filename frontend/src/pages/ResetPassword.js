...
const SecretField = ({ id, label, value, onChange, visible, onToggle, placeholder }) => (
  <div>
    ...
    <div className="relative">
      ...
      <button
        type="button"
        onClick={onToggle}
        className="focus-ring absolute right-2 top-1/2 grid h-9 w-9 -translate-y-1/2 place-items-center rounded-lg text-archive-muted hover:bg-white/5 hover:text-white"
...
const ResetPassword = () => {
  ...
  const passwordPlaceholder = pick("At least 6 characters", "অন্তত ৬টি অক্ষর");
