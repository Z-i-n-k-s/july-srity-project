...
const dictionary = {
  en: {
    ...
    overview: "Overview", users: "Users", submissions: "Submissions", supportCases: "Support Cases",
  ...
  bn: {
    ...
    overview: "সারসংক্ষেপ", users: "ব্যবহারকারী", submissions: "জমা দেওয়া তথ্য", supportCases: "সহায়তা কেস",
